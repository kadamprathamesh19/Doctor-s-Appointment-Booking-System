...
const Appointments = () => {
  ...
  const { doctors, currencySymbol, backend_Url, token, getDoctorsData } = useContext(AppContext)
  ...
  const getAvailabelSlot = async () => {
    ...
    for (let i = 0; i < 7; i++) {
      ...
      if (today.getDate() === currentDate.getDate()) {
        ...
        currentDate.setMinutes(currentDate.getMinutes() > 30 ? 30 : 3)
      } else {
    ...
    <div>
      ...
      <div className='flex flex-col sm:flex-row gap-4'>
        ...
        <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
          ...
          <p className='flex items-center gap-2 text-2xl font font-medium text-gray-900'>
            {docInfo.name}
